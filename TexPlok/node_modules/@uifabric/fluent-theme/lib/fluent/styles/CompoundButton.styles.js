...
export var CompoundButtonStyles = function (props) {
    ...
    return {
        root: tslib_1.__assign({}, getFocusStyle(theme, { inset: 2 }), { backgroundColor: palette.white, border: "1px solid " + palette.neutralSecondaryAlt, borderRadius: effects.roundedCorner2, padding: '16px 12px', 
