...
export var DefaultButtonStyles = function (props) {
    var _a, _b, _c, _d, _e;
    ...
    return {
        root: tslib_1.__assign({ borderRadius: effects.roundedCorner2, backgroundColor: palette.white, border: "1px solid " + palette.neutralSecondaryAlt }, getFocusStyle(theme, { inset: 1 })),
        rootHovered: {
