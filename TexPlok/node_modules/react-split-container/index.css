.react-split-container {
  ...
  min-height: 60px; }
  .react-split-container *,
  .react-split-container *:before,
  .react-split-container *:after {
    box-sizing: border-box; }
  .react-split-container--resizing.react-split-container--orientation-horizontal {
    cursor: ns-resize; }
  .react-split-container--resizing.react-split-container--orientation-vertical {
    cursor: ew-resize; }

.react-split-container__side {
  position: relative;
  overflow: auto; }
...
.react-split-container__splitter,
.react-split-container__resize-proxy {
  background: #d7d7d7; }
...
.react-split-container__splitter {
  -webkit-flex-shrink: 0;
      -ms-flex-negative: 0;
          flex-shrink: 0;
  position: relative; }
  .react-split-container__splitter--orientation-horizontal {
    min-width: 100%;
    height: 12px; }
    .react-split-container__splitter--orientation-horizontal.react-split-container__splitter--collapsed-start {
      cursor: s-resize; }
    .react-split-container__splitter--orientation-horizontal.react-split-container__splitter--collapsed-end {
      cursor: n-resize; }
  .react-split-container__splitter--orientation-horizontal.react-split-container__splitter--draggable:not(.react-split-container__splitter--locked):not(.react-split-container__splitter--collapsed) {
    cursor: ns-resize; }
  .react-split-container__splitter--orientation-vertical {
    position: relative;
    width: 12px;
    min-height: 100%; }
    .react-split-container__splitter--orientation-vertical.react-split-container__splitter--collapsed-start {
      cursor: e-resize; }
    .react-split-container__splitter--orientation-vertical.react-split-container__splitter--collapsed-end {
      cursor: w-resize; }
  .react-split-container__splitter--orientation-vertical.react-split-container__splitter--draggable:not(.react-split-container__splitter--locked):not(.react-split-container__splitter--collapsed) {
    cursor: ew-resize; }

.react-split-container__splitter-inner {
  cursor: pointer;
  position: relative; }

.react-split-container__splitter-inner--orientation-vertical {
  padding: 3px 1px; }
  .react-split-container__splitter-inner--orientation-vertical.react-split-container__splitter-inner--first {
    cursor: w-resize; }
  .react-split-container__splitter-inner--orientation-vertical.react-split-container__splitter-inner--second {
    cursor: e-resize; }

.react-split-container__splitter-inner--orientation-horizontal {
  padding: 1px 3px; }
  .react-split-container__splitter-inner--orientation-horizontal.react-split-container__splitter-inner--first {
    cursor: n-resize; }
  .react-split-container__splitter-inner--orientation-horizontal.react-split-container__splitter-inner--second {
    cursor: s-resize; }
...
.react-split-container--theme-default {
  border: 1px solid #d7d7d7; }
  .react-split-container--theme-default .react-split-container__splitter,
  .react-split-container--theme-default .react-split-container__resize-proxy {
    background: #d7d7d7; }
  .react-split-container--theme-default .react-split-container__splitter--constrained,
  .react-split-container--theme-default .react-split-container__resize-proxy--constrained {
    background: #FFB84F; }
