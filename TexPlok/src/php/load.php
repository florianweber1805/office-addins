<?php
    ...
    $getTextblocks = "SELECT tbs.id AS 'id', i.icon AS 'icon', tbs.name AS 'name', tbs.text AS 'text', tbs.description AS 'description', tbs.author AS 'author', CONVERT(tbs.timestamp, DATE) AS 'timestamp', tbs.type AS 'type' FROM textblock AS tbs
    ...
    $getSubTextblocks = "SELECT tbs.id AS 'id', i.icon AS 'icon', tbs.name AS 'name', tbs.text AS 'text', tbs.description AS 'description', tbs.author AS 'author', CONVERT(tbs.timestamp, DATE) AS 'timestamp', tbs.type AS 'type' FROM textblock_child AS tbc
